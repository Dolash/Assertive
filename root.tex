...
Our intent is that this behavior will be socially compliant to humans and provoke a reciprocal response, completing the interaction. Compliance does not only mean that the robot respects a human's right of way when it would normally apply, but also that the human will respect the robot's own right of way in the reverse case. 
...
One assumption made here is that multi-robot systems introduced to human environments will be autonomous and governed by behaviors like the one we propose for doorway negotiation. [New reference to bridge the gap on why autonomous robots are a good choice for this problem]
...
\textbf{1) Outcome:} The robot-robot interaction experiment had 44 trials, with 5 additional trials discounted due to navigational errors unrelated to our behavior. Of those 44, 40 trials went exactly as planned.  In four other cases, each robot believed the other robot was approaching them and both retreated at first, but correctly resolved the interaction on the second attempt. All trials ended with the correct robot winning the interaction and both arriving at their desired destinations.
...
The outcome results for the human-robot interaction study are in Figure~\ref{fig:Outcomes}. The near-unanimous respect for the human's right of way in all trials when the participant was closest to the door is not very revealing, beyond that the behavior completed successfully without being too obtrusive or aggressive. The bigger challenge for participants came in the second half of each trial, which revealed four discrete categories of participant: 
...
The suggestions from the questionnaire and accounts on how to enhance the interaction demonstrated that participants were looking for more reciprocation from the robot for the social courtesies they were extending, even when they did not recognize the robot's right of way. For those who did, the framing used in their questionnaire responses when explaining their actions cast their decisions in terms of right and mutual recognition. This contrasts with the accounts of those that did not, who emphasized speed, efficiency and the natural priority of humans. 
...
While we saw evidence that our system did provoke reciprocation from some participants, the large proportion who did not respect the robot's right of way shows that work remains in achieving acceptance. Establishing that perception of the robot as participating in human social interactions helps it achieve compliance and overall performance gives us a clear goal to work toward, and participant feedback highlighted what additional behaviors would improve the interaction.
...
This paper proposed an ``assertive" approach for robots to negotiate deadlocks at doors in a way compatible with both robots and humans, by aiming to integrate robots into the existing fabric of human social navigation. We tested our behavior with an experiment and a study, and found it resolved both robot-robot and human-robot impasses. Further, by examining what effect cooperation by humans had on performance and what provoked compliance, we established that recognition of robot participation by humans is an important part of successful social navigation.
