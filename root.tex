...
One assumption made here is that multi-robot systems introduced to human environments will be autonomous and governed by behaviors like the one we propose for doorway negotiation. [New reference to bridge the gap on why autonomous, mobile robots are a good choice for this problem]
...
Our behaviour is presented. In order to test this theory, we have three hypotheses concerning our system that we evaluated through our robot-robot experiment and human-robot study:
...
\textbf{1) Outcome:} The robot-robot interaction experiment had 44 trials, with 5 additional trials discounted due to navigational errors unrelated to our behaviour. Of those 44, 34 trials went exactly as planned.  In four cases each robot believed the other robot was approaching them and both retreated at first, but correctly resolved the interaction on the second attempt, while six trials had recoverable navigational errors unrelated to our behaviour. All trials ended with the correct robot winning the interaction and both arriving at their desired destinations.
     ...
     \begin{figure}
      ...
      \caption{Outcomes Of Human-Robot Study Interactions }
      \label{fig:Outcomes}
   \end{figure}
...
If we break down these time results according to our four participant behaviour categories, seen in Figure~\ref{fig:Respect}, we found that participants who did not respect the robot's right of way had higher trial times than those who did. This reflects that while going out of turn might benefit the human, it degrades the throughput of the overall system. 
     \begin{figure}
      \centering
...
That the teleoperated trial was not notably preferred by participants in questionnaire results and that those who chose it did not cite the human operator as a cause supports that who was ultimately in control was not a significant factor.
